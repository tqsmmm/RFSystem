...
//					}
		...
		/// <param name="ErrMsg"></param>
		/// <returns></returns>
		public int UpdPoInfo(string User,string PoID,string PiType,System.Data.DataSet Ds,out string DocumentID,out string DocDate,out string ErrMsg)
		{
			OutPass pass = new OutPass();
			string SapUser,SapPass;
			DocDate ="";
...
//			param7.ParameterName = "@DocID";
		...
		/// <param name="ErrMsg"></param>
		/// <returns></returns>
		public int UpdReceiveInfo(string User,string PoID,string PiType,System.Data.DataSet Ds,out string DocumentID,out string DocDate,out string ErrMsg)
		{
			OutPass pass = new OutPass();
			string SapUser,SapPass;
			DocDate ="";
...
//				InsertDoc(dt,DocumentID,DocDate,ID,User,Vendor,out ErrMsg);
		...
		/// <param name="ErrMsg"></param>
		/// <returns></returns>
		public int UpdSCLLInfo(string User,string PoID,string PiType,System.Data.DataSet Ds,out string DocumentID,out string DocDate,out string ErrMsg)
		{
			OutPass pass = new OutPass();
			string SapUser,SapPass;
			DocDate ="";
...
//			}
			...
			try
			{
				...
				InsertInfoToRFdb(arrColumnCollection,arrParaCollection,DtToRF,"t_stockout",out ErrMsg);
				#endregion
#endif
...
//				DocDate = System.DateTime.Now.Year.ToString();
		...
		/// <param name="ErrMsg"></param>
		/// <returns></returns>
		public int UpdBF(string User,string DesUser,string PoID,string PiType,System.Data.DataSet Ds,out string DocumentID,out string DocDate,out string ErrMsg)
		{
			OutPass pass = new OutPass();
			string SapUser,SapPass;
			DocDate ="";
...
//					pop.Pct51 = pop.Bct51+pop.Bct61+pop.Bct71;
			...
			try
			{
				...
				InsertInfoToRFdb(arrColumnCollection,arrParaCollection,DtToRF,"t_stock_bfk",out ErrMsg);
...
//				InsertDoc(dt,DocumentID,DocDate,ID,User,Vendor,out ErrMsg);
		...
		/// <param name="ErrMsg"></param>
		/// <returns></returns>
		public int UpdBFCK(string User,string Plant,System.Data.DataSet Ds,out string DocumentID,out string DocDate,out string ErrMsg)
		{
			OutPass pass = new OutPass();
			string SapUser,SapPass;
			DocDate ="";
...
//					pop.Bct71 = Convert.ToDecimal(Ds.Tables["Detail"].Rows[i]["BinCount3"].ToString()==""?"0":Ds.Tables["Detail"].Rows[i]["BinCount3"].ToString());
			...
			try
			{
				...
				InsertInfoToRFdb(arrColumnCollection,arrParaCollection,DtToRF,"t_stock_bfck",out ErrMsg);
				#endregion
#endif
...
//					} 
		...
		public int UpYKInfo(string User ,string PiType,System.Data.DataSet Ds,out string ErrMsg)
		{
			OutPass pass = new OutPass();
			string SapUser,SapPass;
			if(0!=pass.DbUserGetSapPass(User,out SapUser,out SapPass,out ErrMsg))
			...
			try
			{
				...
				InsertInfoToRFdb(arrColumnCollection,arrParaCollection,DtToRF,"t_stock_op ",out ErrMsg);
#endif
