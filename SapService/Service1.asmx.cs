...
/// <returns></returns>
        ...
        /// <summary>
        /// 查询一维条码和原先的物料条码的对照关系，返回一维条码、物料条码及其它信息
        /// </summary>
        /// <param name="ywtm"></param>
        ...
        [WebMethod]
        [System.Web.Services.Protocols.SoapHeader("header")]
        public MessagePack GetHWCXInfo_RF(string BaoGuanYuan/*保管员*/, string HuoWei/*货位*/, string Lgort/*库存地点*/, string Werks/*工厂*/, out System.Data.DataSet cxDs)
        {
            MessagePack pak = new MessagePack();
            string ErrMsg = "";
            cxDs = new DataSet();
