...
namespace SapService
{
  ...
  /// 
  /// </summary>
  [RfcStructure(AbapName ="ZSMM_RFC_POM" , Length = 162, Length2 = 300)]
  [Serializable]
  public class ZSMM_RFC_POM : SAPStructure
  {
    ...
    [RfcField(AbapName = "MAKTX", RfcType = RFCTYPE.RFCTYPE_CHAR, Length = 40, Length2 = 80, Offset = 108, Offset2 = 198)]
    [XmlElement("MAKTX")]
    public string Maktx
    { 
       get
    ...
    [RfcField(AbapName = "MEINS", RfcType = RFCTYPE.RFCTYPE_CHAR, Length = 3, Length2 = 6, Offset = 148, Offset2 = 278)]
    [XmlElement("MEINS")]
    public string Meins
    { 
       get
    ...
    [RfcField(AbapName = "CLABS", RfcType = RFCTYPE.RFCTYPE_BCD, Length = 7, Length2 = 7, Decimals = 3, Offset = 151, Offset2 = 284)]
    [XmlElement("CLABS")]
    ...
    [RfcField(AbapName = "LGORT", RfcType = RFCTYPE.RFCTYPE_CHAR, Length = 4, Length2 = 8, Offset = 158, Offset2 = 292)]
    [XmlElement("LGORT")]
    public string Lgort
    { 
       get
