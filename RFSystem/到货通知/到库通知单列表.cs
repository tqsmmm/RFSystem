...
namespace RFSystem.ArriveStore
{
    public partial class 到库通知单列表 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridViewArriveGoodsInfo.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.CellSelect;
        ...
        public 到库通知单列表()
        {
            ...
            if (!AppSetter.User_Info.isAdmin)
            {
                ...
                {
                    this.textBoxTableMaker.Text = AppSetter.User_Info.userID;
                    this.textBoxTableMaker.ReadOnly = true;
                }
                else
                {
                    this.textBoxKeeper.Text = AppSetter.User_Info.userID;
        ...
        private void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            dealInfo.Add(string.Empty);
            dealInfo.Add(AppSetter.User_Info.userID);
