...
namespace RFSystem.ArriveStore
{
    public partial class 到库通知单 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridViewStorageInfo.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.CellSelect;
        ...
        public 到库通知单()
        {
            ...
            this.regex = new Regex(AppSetter.REGEX_NUM);
            this.textBoxTableMakerID.Text = AppSetter.User_Info.userID;
            this.textBoxTableMaker.Text = AppSetter.User_Info.userName;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (num == Convert.ToDecimal(textBoxAcceptAmount.Text))
                {
                    ...
                    string str = DBOperate.ArriveStoreNewBill(AppSetter.User_Info.userID, "ARRIVESTORE", billInfo, this.storageInfoList);
                    if (!str.Equals("-1"))
                    {
        ...
        private void textBoxKeeperID_Leave(object sender, EventArgs e)
        {
            ...
            {
                DataTable userIDName = UserInfo.GetUserIDName(this.textBoxKeeperID.Text);
        ...
        {
            labelArriveListID.Text = AppSetter.User_Info.userID + DateTime.Now.ToString("yyMMdd") + "****";
        }
    }
